...
namespace TiledMap
{
    ...
    public partial class TiledMapSave
    {
        ...
        public NodeNetworkSave ToNodeNetworkSave()
        {
            ...
            foreach (mapLayer layer in this.layer)
            {
                ...
                foreach (int gid in layer.data[0].tiles)
                {
                    ...
                    calculateWorldCoordinates(layercount, count, tilewidth, tileheight, out node.X, out node.Y, out node.Z);
        ...
        public SpriteEditorScene ToSpriteEditorScene()
        {
            ...
            foreach (mapLayer layer in this.layer)
            {
                ...
                foreach (int gid in layer.data[0].tiles)
                {
                    ...
                    calculateWorldCoordinates(layercount, count, tilewidth, tileheight, out sprite.X, out sprite.Y, out sprite.Z);
        ...
        private void calculateWorldCoordinates(int layercount, int count, int tileWidth, int tileHeight, out float x, out float y, out float z)
        {
            ...
            else if (this.orientation != null && this.orientation.Equals("isometric"))
            {
                ...
                z = -((normalizedY + normalizedX) * .0001f) - layercount;
            }
            else
            {
